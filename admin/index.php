	...
	<div class="wrapper">
		...
		<div class="sidebar-wrapper" data-simplebar="true">
			<div class="sidebar-header">
				<div>
					<img src="../assets/images/bawaslu-logo.png" width="50px" height="50px" alt="logo icon">
				</div>
				<div>
					<h4 class="logo-text">Bawaslu Merauke</h4>
				</div>
			...
			<ul class="metismenu" id="menu">
				...
				<li>
					...
					<ul>
						...
						<li>
							<a href="index.php?page=laporan_kegiatan"><i class="bx bx-task"></i>Laporan Masuk</a>
						</li>
						<li>
							<a href="index.php?page=jenis_laporan"><i class="bx bx-book-add"></i>Jenis Laporan</a>
						</li>
						<!--<li>
							<a href="index.php?page=print_laporan"><i class="bx bx-book"></i>Cetak Form</a>
						</li> -->
				...
				if (isset($_GET['page'])) {
					...
					switch ($page) {
						...
						case 'print_laporan':
							...
							break;
						case 'jenis_laporan':
							include "laporan/jenis_laporan.php";
							break;
		...
		<footer class="page-footer">
			<p class="mb-0">Copyright © 2024. Bawaslu Kabupaten Merauke | Created by <a href='https://stokcoding.com/' title='StokCoding.com' target='_blank'>Admin</a>
			</p>
		</footer>
	</div>
	<!--end wrapper-->
