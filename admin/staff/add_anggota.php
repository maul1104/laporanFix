            ...
            <div class="card-body">
                <div class="border p-4 rounded">
                    ...
                    <form action="" method="POST" enctype="multipart/form-data">
                        <div class="row mb-3">
                            <label for="nrp" class="col-sm-3 col-form-label">ID</label>
                            <div class="col-sm-9">
                                <input type="number" name="nrp" class="form-control" id="nrp" placeholder="ID">
                            </div>
                        </div>
                        <div class="row mb-3">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="pangkat" class="form-control" id="pangkat" placeholder="jabatan">
                            </div>
                        </div>
                        <hr>
                        <div class="row mb-3">
