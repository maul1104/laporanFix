...
<body>
	...
	<div class="wrapper">
			...
			<ul class="metismenu" id="menu">
				...
				<li>
					<a href="javascript:;" class="has-arrow">
						...
						<div class="menu-title">Laporkan Pelanggaran</div>
					</a>
					<ul>
						<li>
							<a href="dashboard.php?page=add_laporan"><i class="bx bx-calendar-star"></i>Buat Laporan</a>
						</li>
						<li>
							<a href="dashboard.php?page=riwayat_laporan"><i class="bx bx-history"></i>Riwayat Laporan</a>
						</li>
					</ul>
				</li>
			</ul>
			...
			<div class="topbar d-flex align-items-center">
				<nav class="navbar navbar-expand">
					...
					<div class="col-lg-3 col-xl-2">
                        <a class="btn btn-primary mb-3 mb-lg-0" href="index.php?"><i class='bx bxs-left-arrow-circle'></i>Kembali</a>
                    </div>
				</nav>
			</div>
		</header>
		...
		<footer class="page-footer">
			<p class="mb-0">Copyright © 2024. Bawaslu Kabupaten Merauke.</p>
		</footer>
	</div>
	<!--end wrapper-->
	<!-- Bootstrap JS -->
