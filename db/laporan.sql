...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 10 Jan 2024 pada 04.27
...
CREATE TABLE `laporan_kegiatan` (
  ...
  `nohp_terlapor` int(30) DEFAULT NULL,
...
INSERT INTO `laporan_kegiatan` (`id_laporan`, `judul_laporan`, `identitas`, `jenis_kelamin`, `no_hp`, `pekerjaan`, `kewarganegaraan`, `lokasi`, `peristiwa`, `nama_terlapor`, `nohp_terlapor`, `tgl`, `isi`, `created_by`, `created_at`, `status`) VALUES
(15, 'budi', '7854224', 'laki-laki', 866201, 'nganggur', 'asing', 'tps 04 jl. seringgu', 'pencuri kertas', 'rian', 908665, '2024-01-09', 'jklmno', '15', '2024-01-09', 'DITERIMA'),
(18, 'andi', '85598679', 'laki-laki', 866201, 'nganggur', 'asing', 'tps 04 jl. seringgu', 'pencuri kertas', 'rian', 978755861, '2024-01-10', 'uiioppp', '15', '2024-01-10', 'DITOLAK'),
(19, 'hjtytdyiful', '85598679', 'laki-laki', 866201, 'jccj', 'nmkjj', 'lhyidukddu6', 'pencuri kertas', 'rian', 978755861, '2024-01-10', '', '15', '2024-01-10', 'DITOLAK');
...
(15, '22019988', 'rizki ratih purwasih', 'perempuan', 'pengawas lapangan', '12345', 'anggota'),
(16, '2345', 'Julian', 'laki-laki', 'saksi', '123456', 'anggota');
