        ...
        <div class="card border-top border-0 border-4 border-warning">
            <div class="card-body">
                <div class="border p-4 rounded">
                    ...
                    <button type="button" class="btn btn-success px-2" onClick="Javascript:window.location.href = 'dashboard.php?page=riwayat_laporan';"><i class='bx bx-check mr-1'></i> Berhasil Mengirimkan Laporan, Check Riwayat Laporan</button>
                    <?php } else {
                    ?>
                    <form action="" method="POST" enctype="multipart/form-data">
                        <div class="row mb-3">
                            <label for="tgl" class="col-sm-3 col-form-label">Upload bukti foto laporan</label>
                            <div class="col-sm-9">
                            <input id="image-uploadify" type="file" name="foto[]" accept="image/*" multiple>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <label for="tgl" class="col-sm-3 col-form-label">Upload bukti video laporan</label>
                            <div class="col-sm-9">
